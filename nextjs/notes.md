...
## 📁 app/(application)/ - Application Section
...
Root Layout (app/layout.js)
  └── Application Layout (app/(application)/layout.js)
      ├── About Page
      └── Blogs Pages
```
...
### 📁 app/(application)/blogs/[blogId]/ - Dynamic Route
...
### 📁 app/(application)/blogs/[blogId]/comments/
...
## 📁 app/(marketing)/ - Marketing Section
...
- **Triple nesting:**
  - Root Layout → Marketing Layout → Services Layout → Page

---

### 📁 app/(marketing)/services/web-dev/
...
### 📁 app/(marketing)/files/[[...catchAll]]/ - Catch-All Route
...
global-error.js (catches root layout errors)
  └── error.js (catches page/layout errors)
      └── [blogId]/error.js (catches blog-specific errors)
```
...
## 📝 Component Type Cheatsheet

### Server Components (Default)

✅ Can access server-side resources (databases, file system)
...
```
✅ PascalCase for components: Header.js, Button.jsx
✅ lowercase for routes: page.js, layout.js
✅ Descriptive names: ThemeContext.js, not context.js
```
...
# Nested route
app/blog/[id]/comments/page.js → /blog/123/comments
